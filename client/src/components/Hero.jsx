...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden border-b border-white/10">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full relative z-10 pb-24">
        <motion.div
        ...
        >
          ...
          <p className="text-gray-400 text-lg md:text-xl font-body font-light max-w-xl mb-4 leading-relaxed">
            Rs 50L+ in client revenue managed monthly. Two partnerships.
            Zero wasted spend. We don't do average.
          </p>

          <div className="flex flex-wrap items-center gap-x-6 gap-y-2 mb-12 text-xs text-gray-500 font-medium tracking-widest uppercase">
