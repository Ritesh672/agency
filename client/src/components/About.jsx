...
const founders = [
  {
    ...
    bio: "Leads strategy and client relationships. Experienced in D2C growth marketing — the brain behind the campaigns.",
    linkedin: "#",
  ...
  },
  {
    initial: "R",
    name: "Ritesh Y.",
    role: "Co-Founder — Marketing & Dev",
    bio: "Works across both performance marketing and development. Builds and runs the ads, manages campaigns manually, and codes the tech side. The all-rounder keeping everything moving.",
    linkedin: "#",
  ...
  },
  {
    ...
    bio: "Leads the technical build — websites, landing pages, and conversion-focused development that turns traffic into revenue.",
    linkedin: "#",
            ...
            <div className="space-y-4">
              {founders.map((founder, idx) => (
                <motion.div
                  ...
                  className="bg-dark-card border border-white/8 p-5 flex gap-4 hover:border-gold/20 transition-colors duration-300 group relative overflow-hidden"
                >
                  ...
                  <div className="w-12 h-12 rounded-full bg-gold/10 border border-gold/20 flex items-center justify-center flex-shrink-0 group-hover:bg-gold/25 transition-colors duration-300 relative z-10">
                    <span className="font-display text-gold text-lg font-bold">{founder.initial}</span>
                  </div>
                  <div className="flex-1 relative z-10">
                    <div className="flex items-start justify-between mb-1">
                      <div>
                        <h3 className="text-white font-medium text-sm">{founder.name}</h3>
                        <p className="text-gold text-[10px] tracking-wider uppercase font-bold mb-1.5">{founder.role}</p>
                      </div>
                      <a href={founder.linkedin} className="text-gray-600 hover:text-gold transition-colors mt-0.5" aria-label="LinkedIn">
              ...
              <motion.div
                ...
                className="border border-white/5 p-5 flex items-center justify-between mt-2"
              >
                <div>
